...
The principal scope of this project is showing complete info about ME as a Full Stack Web Developer, the most relevant projects, and contact info. This website has been created using bootstrap's grid system and components as well as the Mdboostrap framework to ensure it renders well on different devices and window sizes.
...
![picture](./Assets/images/aboutmesmallsize.jpg)
...
### Contact
![picture](./Assets/images/contact.png)
---
## Author Info
